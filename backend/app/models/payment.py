...
class Deposit(BaseModel):
    ...
    status: Mapped[DepositStatus] = mapped_column(Enum(DepositStatus, native_enum=False), default=DepositStatus.initiated, index=True, nullable=False)
...
class Withdrawal(BaseModel):
    ...
    currency: Mapped[str] = mapped_column(String(3), default="UGX", nullable=False)
    status: Mapped[WithdrawalStatus] = mapped_column(Enum(WithdrawalStatus, native_enum=False), default=WithdrawalStatus.requested, index=True, nullable=False)
...
class SettlementRecord(BaseModel):
    ...
    currency: Mapped[str] = mapped_column(String(3), default="UGX", nullable=False)
    status: Mapped[FinancialState] = mapped_column(Enum(FinancialState, native_enum=False), default=FinancialState.pending, index=True, nullable=False)
